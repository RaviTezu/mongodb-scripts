...
def data_backup(prefix, data, out, dbtype):
    ...
    #For catching any exception, I'm using only except here. For knowing the cause
    #Please refer to the output generated by fabric, I need to improvise this when time permits. 
    except: 
